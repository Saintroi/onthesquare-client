...
if (isElmNeed()) {
tryInjectRosettaScript('https://d1q3axnfhmyveb.cloudfront.net/rosetta/translations/new-frontend/files/new-frontend.en.-405563486.js');
} else {
}
})();
(function() {
...
script.src = selectJsVersion('https://d1q3axnfhmyveb.cloudfront.net/venera/static/ecwid-storefront.9236e757f6cff7acd08d3c8752c715ba.min.js');
document.getElementsByTagName('head')[0].appendChild(script);
}
...
script.src = selectJsVersion('https://d1q3axnfhmyveb.cloudfront.net/venera/static/ecwid-checkout.d9ad8cf12fc5a070fd6781a980766126.min.js');
document.getElementsByTagName('head')[0].appendChild(script);
}
...
signature: "daa5350d29f420e121e94af6b818c446-0",
...
window.ec_legacyCssUrl = 'https://d1oxsl77a1kjht.cloudfront.net/css/new/cut?hc=-1674686323&ownerid=22606304&useProximaNovaFont=true' + cssUrlAddition;
var cssUrl = 'https://d1oxsl77a1kjht.cloudfront.net/css/new?hc=-1674686323&ownerid=22606304&useProximaNovaFont=true' + cssUrlAddition;
...
j[Kb]=function(){var a=navigator.userAgent.toLowerCase();var b=p.documentMode;if(function(){return a.indexOf(Lb)!=-1}())return Mb;if(function(){return a.indexOf(Nb)!=-1&&(b>=gb&&b<Ob)||a.indexOf(Pb)!=-1}())return Qb;if(function(){return a.indexOf(Nb)!=-1&&(b>=Rb&&b<Ob)}())return Sb;if(function(){return a.indexOf(Tb)!=-1||(a.indexOf(Ub)!=-1||a.indexOf(Nb)!=-1&&(b>=Vb&&b<Ob))}())return Wb;if(function(){return a.indexOf(Xb)!=-1||(b>=Ob||a.indexOf(Yb)!=-1)}())return Zb;return Mb};i[Kb]={'gecko1_8':W,'ie10':X,'ie8':$b,'ie9':_b,'safari':ac};__gwt_isKnownPropertyValue=function(a,b){return b in i[a]};ru_cdev_xnext_frontend_Main.__getPropMap=function(){var a={};for(var b in i){if(i.hasOwnProperty(b)){a[b]=k(b)}}return a};ru_cdev_xnext_frontend_Main.__computePropValue=k;o.__gwt_activeModules[T].bindings=ru_cdev_xnext_frontend_Main.__getPropMap;r(P,bc);if(q()){return F(cc)}var l;try{h([Sb],dc);h([Qb],ec);h([Mb],fc);h([Zb],gc);h([Wb],hc);l=f[k(Kb)];var m=l.indexOf(ic);if(m!=-1){g=parseInt(l.substring(m+X),gb);l=l.substring(W,m)}}catch(a){}ru_cdev_xnext_frontend_Main.__softPermutationId=g;return F(l+jc)}
...
window.ecwid_script_base="https://d1q3axnfhmyveb.cloudfront.net/static/br/2020-4190-g096873c883e/";
...
window.xnext_ownerId=22606304;
window.Ecwid.publicToken = "public_FcnTk3CdtrRn91XMS7zqFWq9cbvbN9Eh",
window.Ecwid.demo=false;
window.Ecwid.cssUrl="https://d1oxsl77a1kjht.cloudfront.net/css/new?hc=-1674686323&ownerid=22606304&useProximaNovaFont=true";
...
var ecDataJsBaseUrl = "https://app.ecwid.com/data.js?ownerid=22606304";
...
var publicData = {"storefront-label-editor":"%7B%22en%22%3A%7B%22NewStorefront.featured_products%22%3A%22All%20Products%22%7D%7D","import-coupons":"{}","custom-app-22606304-2":"{}","ecwid-edit-orders":"{}","ecwid-storefront":"{}","custom-app-22606304-1":"{}","ecwid-degenerator-app":"{}","ecwid-android-app":"{}","square":"{}","starter-site":"{}","ecwid-startersite-app":"{}","ecwid-iphone-app":"{}"};
...
var tokenMap = {"custom-app-22606304-2":"public_yzCNT5bS6zGAL5G8B1hBBSYp2wEhbJD8","ecwid-storefront":"public_kJTgcja89f3kNvBBagE3a2EyQ7p3AihH","custom-app-22606304-1":"public_61AFXyvtkLHgyzkRKPmaDfHHpmqY9y58"};
